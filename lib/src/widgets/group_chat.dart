...
import 'message/group_message.dart';
...
class GroupChat extends StatefulWidget {
  ...
  /// See [autoScrollIndexById].
  final void Function(Map<String, int> autoScrollIndexById)?
      autoScrollIndexById;
...
class GroupChatState extends State<GroupChat> {
  ...
  @override
  void didUpdateWidget(covariant GroupChat oldWidget) {
    super.didUpdateWidget(oldWidget);

    if (widget.messages.isNotEmpty) {
      final result = calculateGroupChatMessages(
        widget.messages,
        widget.user,
    ...
    if (object is DateHeader) {
      ...
      if (message is types.SystemMessage) {
        ...
        messageWidget = GroupMessage(
          ...
          onMessageShareTap: widget.onMessageShareTap,
  ...
  void _refreshAutoScrollMapping() {
    ...
    widget.autoScrollIndexById?.call(_autoScrollIndexById);
  }
}
